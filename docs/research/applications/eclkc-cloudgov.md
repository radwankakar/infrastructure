...
Once we had permission to access cloud.gov, I installed [cloudfoundry CLI (7)](https://docs.cloudfoundry.org/cf-cli/install-go-cli.html#pkg-mac) and was able to [access the web GUI and use cf on the command line](https://cloud.gov/docs/getting-started/setup/).

## Standing up the server

You can use cloud.gov in one of two ways: containerize your app outside of cloud.gov and run it inside cloud.gov or push your app code in cloud.gov and have the container built for you. Either way, the apps well-suited to cloud.gov can run in stateless container.
